...
| Name         | Description                                                                                                       |
|--------------|------------------------------------------------------------------------------------------------------------------ |
| `setup`      | [`setup`](/current/reference/prorgams/setup/) programs <Badge text="Iris Only" variant="tip" size="small" /> |
| `begin`      | [`begin`](/current/reference/programs/begin/) programs <Badge text="Iris Only
" variant="tip" size="small" /> |
...
## `customTexture` directive <Badge text="Iris Only" variant="tip" size="medium" />
