...
## sky <Badge text="Iris Only" variant="tip" size="medium" />
```properties
sky=<true|false>
```
...
## stars <Badge text="Iris Only" variant="tip" size="medium" />
```properties
stars=<true|false>
```
...
## supportsColorCorrection <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## weather <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## endFlashShadows <Badge text="Iris Only" variant="tip" size="medium" />
```properties
