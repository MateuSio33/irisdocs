...
## particles.ordering <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## separateEntityDraws <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## shadow.enabled <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## shadowPlayer <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## shadowLightBlockEntities <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## skipAllRendering <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## voxelizeLightBlocks <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## indirect.pass <Badge text="Iris Only" variant="tip" size="medium" />
```properties
...
## allowConcurrentCompute <Badge text="Iris Only" variant="tip" size="medium" />
```properties
